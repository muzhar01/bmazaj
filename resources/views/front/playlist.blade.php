...
<!-- module_row -->
<div style="height:75vh; padding: 10px 3px">
        ...
        <div class="simp-playlist">
            <ul>
              @foreach ($audio as $list)
                <li>
                  <span class="simp-source" data-src="{{ asset('/storage/media/audio/file/'.$list->audio) }}">{{ $list->title }}</span>
...
function simp_startScript() {
    console.log("Call to audio player :: ");
