...
@section('container')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <form action="{{ route('sp-settings.update', $sp->id ?? '') }}" method="post">
                        @method('put')
                        @csrf
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input id="spName" type="text" name="name" class="form-control" placeholder="Service Provider Name" value="{{ $sp->name ?? '' }}">
                                        @if ($errors->has('name'))
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input id="link" type="text" name="link" class="form-control" placeholder="Service Provider Link" value="{{ $sp->link ?? '' }}">
                                        @if ($errors->has('link'))
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input id="email" type="text" name="email" class="form-control" placeholder="Enter Registered Email" value="{{ $sp->email ?? '' }}">
                                        @if ($errors->has('email'))
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input id="password" type="password" name="password" class="form-control" placeholder="Enter Password" autocomplete="off"  value="{{ $sp->password ?? '' }}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-9">
                                        ...
                                        <input id="token" type="text" name="token" class="form-control" placeholder="Enter token if available" value="{{ $sp->token ?? '' }}">
                                        @if ($errors->has('token'))
